    ...
    <div id="carousel-listing" class="carousel slide post-carusel carouselvertical" data-ride="carousel" data-interval="false">
        ...
        if( has_post_thumbnail() ){
            ...
            $slides .= '<div class="item '.esc_attr($active).' ">
                            <a href="'.esc_url($full_img[0]).'" title="'.esc_attr($attachment_meta['caption']).'"  rel="data-fancybox-thumb" class="fancybox-thumb">
        ...
        foreach ($post_attachments as $attachment) {
            ...
            $slides .= '<div class="item '.esc_attr($active).'">
                            <a href="'.esc_url($full_img[0]).'" rel="data-fancybox-thumb" title="'.esc_attr($attachment_meta['caption']).'" class="fancybox-thumb">
