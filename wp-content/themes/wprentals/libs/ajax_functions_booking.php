...
if( !function_exists('wpestate_create_pay_user_invoice_form') ):
    function wpestate_create_pay_user_invoice_form(){
        ...
        if($booking_array['numberDays']>=7 && $booking_array['numberDays']< 30 && intval($booking_array['week_price']!=0)){
            $default_price=$booking_array['week_price'];
        }else if($booking_array['numberDays']>30 && intval($booking_array['month_price']!=0) ){
                       ...
                       <div class="invoice_data">
                        ...
                        print ' 
                            <div class="invoice_row invoice_total total_inv_span total_invoice_for_payment">
                               ...
                               <span class="inv_legend invoice_reseration_fee_req">'.esc_html__( 'Reservation Fee Required','wprentals').':</span> <span class="inv_depozit depozit_show" data-value="'.esc_attr($depozit).'"> '.$service_fee_show.'</span></br>
