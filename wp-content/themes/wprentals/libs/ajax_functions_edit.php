                   ...
                   <div class="invoice_table">
                        ...
                        print '
                            <div class="invoice_row invoice_total total_inv_span total_invoice_for_payment">
                               ...
                               <span class="inv_legend invoice_reseration_fee_req giorgio_commissioni_ricevuta_indefinita_edit">'.esc_html__( 'Reservation Fee Required','wprentals').':</span> <span class="inv_depozit depozit_show" data-value="'.esc_attr($depozit).'"> '.$service_commissioni.'</span></br><!-- giorgio replace $depozit_show > $service_commissioni-->
